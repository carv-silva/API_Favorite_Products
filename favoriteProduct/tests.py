...
class CustomerTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.customer = Customer.objects.create(name='cliente Teste do Case', email='clienteteste@gmail.com')
    ...
    def test_customer_create(self):
        ...
        data = {"name": "cliente Teste do Case02", "email": "teste02@gmail.com"}
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)

    def test_customer_create_duplicated_email(self):
        url = reverse('customers-list')
        data = {"name": "cliente Teste do Case", "email": "clienteteste@gmail.com"}
        response = self.client.post(url, data, format='json')
    ...
    def test_customer_update(self):
       data = {"name": "cliente Teste do Case ATUALIZADO", "email": "clienteteste@gmail.com"}
       url = reverse('customers-detail', kwargs={'pk': self.customer.id})
